Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Yamm-Software/ECSlidingViewController"
  s.license      = 'MIT'
  s.author       = { "Roger Mabillard" => "info@yamm.ca" }
  s.source       = { :git => "https://github.com/Yamm-Software/ECSlidingViewController.git", :tag => "2.0.2" }
